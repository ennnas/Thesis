...
//#define SPALLA_START_POSITION 1479 // Posizione iniziale di 180°
//#define GOMITO_START_POSITION 1024
#define OFFSET_SPALLA 285*1.3 // Oscillazione angolo spalla di 25°
#define OFFSET_GOMITO 341*2 // Oscillazione angolo gomito di 30°
#define N_CAMP 10 // Numero di campioni da scartare 
#define GAIT 2 // Tipo di gait da eseguire 1 Camminata Lenta , 2 Trotto , 3 Galoppo
...
int SPALLA_START_POSITION[] = {1551,1559,1446,1579};
...
void loop() {
  int x;
    ...
    for(int i=0; i<4;i=i+1){
          ...
          Legs[i].servo(ID_SPALLA,angoli[i][0]*x,0x090);
          Legs[i].servo(ID_GOMITO,angoli[i][1]*x,0x090);
