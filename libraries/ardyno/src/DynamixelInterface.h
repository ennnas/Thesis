...
class DynamixelInterface
{
	...
	template<class T>
	inline DynamixelStatus multiwrite(uint8_t sID,uint8_t gID, uint8_t aAddress, const T& sData, const T& gData, uint8_t aStatusReturnLevel=2);
	template<class T>
	...
	DynamixelStatus multiwrite(uint8_t sID, uint8_t gID, uint8_t aAddress, uint8_t aSize, const uint8_t *sPtr, const uint8_t *gPtr, uint8_t aStatusReturnLevel=2);
...
template<class T>
DynamixelStatus DynamixelInterface::multiwrite(uint8_t sID,uint8_t gID, uint8_t aAddress, const T& sData, const T& gData, uint8_t aStatusReturnLevel)
{
	return multiwrite(sID, gID, aAddress, uint8_t(sizeof(T)), (const uint8_t*)&sData, (const uint8_t*)&gData, aStatusReturnLevel);
}
template<class T>
