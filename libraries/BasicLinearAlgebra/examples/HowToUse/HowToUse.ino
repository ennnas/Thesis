...
void setup() 
{
  ...
  Matrice<3,6> AleftOfB = A || B;

  // And vertically
  Matrice<6,3> AonTopOfB = A && B;
  ...
  Matrice<3> x; Matrice<2> u; Matrice<3,2> G; Matrice<3,3> F; float dt;
  x += (F * x + G * u) * dt;
